...
2. This is not rungo's error but you call FromError();
3. rungo got unexpected error and don't know how to handle it, and then return Unknown error
...
Sometimes, you believe you got rungo error, but actually you don't, and then you call FromError(err)
