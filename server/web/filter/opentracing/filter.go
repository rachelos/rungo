...
type FilterChainBuilder struct {
	...
	CustomSpanFunc func(span opentracing.Span, ctx *rungoCtx.Context)
}

func (builder *FilterChainBuilder) FilterChain(next web.FilterFunc) web.FilterFunc {
	return func(ctx *rungoCtx.Context) {
		var (
		...
		span.SetTag("rungo.route", ctx.Input.GetData("RouterPattern"))
...
func (builder *FilterChainBuilder) operationName(ctx *rungoCtx.Context) string {
